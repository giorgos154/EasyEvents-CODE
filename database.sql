...
INSERT INTO events (organizer_id, title, description, category, event_date, venue, is_public, max_participants, is_paid, cost, payment_method, status) VALUES
  ...
  (1, 'Summer Coding Camp', 'Transform from beginner to confident coder in this intensive 5-day workshop. Curriculum covers: HTML5/CSS3, JavaScript fundamentals, React basics, and building full-stack applications.', 'Workshop', '2025-06-25 17:00:00', 'Thessaloniki City Hall', TRUE, 50, TRUE, 200.00, 'credit_card', 'scheduled'),
  ...
  (4, 'Art in Motion', 'Experience art like never before in this unique exhibition where traditional artwork meets modern technology.', 'Art', '2025-07-10 09:00:00', 'Thessaloniki Cultural Center', TRUE, NULL, FALSE, 0.00, NULL, 'scheduled'),
...
INSERT INTO event_participations (user_id, event_id, registration_date, status) VALUES
  ...
  (2, 9, '2024-01-07 16:00:00', 'registered'),
  (2, 10, '2025-01-01 02:00:00', 'registered'),
  (2, 11, '2024-12-22 14:00:00', 'registered');
...
INSERT INTO invitations (sender_userid, receipient_userid, event_id, sender_message, status) VALUES
  ...
  (4, 2, 5, 'Come to the art exhibition! It will be a unique experience.', 'pending'),
  (4, 2, 6, 'The Greek music night will take you on a journey!', 'accepted'),
  (1, 2, 7, 'Don''t miss the blockchain workshop, it will be hands-on.', 'pending'),
  (4, 2, 8, 'Interested in photography? Join me at the masterclass!', 'rejected');
