...
INSERT INTO events (organizer_id, title, description, category, event_date, venue, is_public, max_participants, is_paid, cost, payment_method, status) VALUES
  (1, 'Tech Meetup', 'Join the premier tech networking event of the month! Features live tech demos, lightning talks from industry experts, and hands-on workshops. This month''s speakers include leaders from major tech companies discussing AI, Cloud Computing, and Mobile Development. Perfect opportunity to expand your professional network while staying updated with latest tech trends. Includes refreshments and exclusive access to our online community.', 'Technology', '2025-06-15 18:00:00', 'Athens Concert Hall', TRUE, 150, FALSE, 0.00, 'cryptocurrency', 'scheduled'),
